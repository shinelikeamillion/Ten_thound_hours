...
public class Sprite {
	...
	protected RectF collRect = new RectF();
	...
	public boolean isCollWith(Sprite sprite) {
		//设置碰撞区域
		collRect.top = drawRect.top + getHeight() / 3;
		collRect.bottom = drawRect.bottom  - getHeight() / 4;
		collRect.left = drawRect.left + getWidth() /6;
		collRect.right = drawRect.right - getWidth() / 6;
		
		return RectF.intersects(collRect, sprite.getDrawRect());
	}
